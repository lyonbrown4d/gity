...
func (e *Endpoint) Register(registrar httpx.Registrar) {
	...
	httpapi.MustRegisterRoutes(registrar,
		...
		httpapi.Get("/projects/{id}", e.getProject, httpapi.RequireProjectReadRoute[projectByIDInput, projectOutput](e.authRuntime, projectWrite)),
		httpapi.Get("/repos/{id}", e.getProject,
			httpapi.RequireProjectReadRoute[projectByIDInput, projectOutput](e.authRuntime, projectWrite),
